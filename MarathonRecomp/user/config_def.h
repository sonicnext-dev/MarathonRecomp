...
CONFIG_DEFINE_HIDDEN("Codes", bool, EnablePostureImprovements, false, false);
...
CONFIG_DEFINE_HIDDEN("Codes", bool, AlwaysResetSpringState, false, false);
...
CONFIG_DEFINE_HIDDEN("Codes", bool, DisableSilverPsychoRideHeightLimit, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, AllowSpinDashJump, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, DisableMachStateLockInput, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, AlwaysBlueGem, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, EnableGemsAura, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, EnableColoredAuraForGems, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, UnlockAllUpgrades, false, true);
CONFIG_DEFINE_HIDDEN("Codes", bool, FixShoesParticleOffsetSwap, false, true);
