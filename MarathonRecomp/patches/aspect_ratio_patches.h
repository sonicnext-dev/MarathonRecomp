...
enum CsdFlags : uint64_t
{
    ...
    CSD_REPEAT_UP = MAKE_BITFLAG64(16),
    CSD_REPEAT_DOWN = MAKE_BITFLAG64(17),
    CSD_REPEAT_FLIP_HORIZONTAL = MAKE_BITFLAG64(18),
    CSD_REPEAT_FLIP_VERTICAL = MAKE_BITFLAG64(19),
    CSD_REPEAT_EXTEND = MAKE_BITFLAG64(20),

    CSD_UV_MODIFIER = MAKE_BITFLAG64(21),
    CSD_COLOUR_MODIFIER = MAKE_BITFLAG64(22),
    CSD_REPEAT_UV_MODIFIER = MAKE_BITFLAG64(23),
    CSD_REPEAT_COLOUR_MODIFIER = MAKE_BITFLAG64(24),

    CSD_BLACK_BAR = MAKE_BITFLAG64(25),
    CSD_PROHIBIT_BLACK_BAR = MAKE_BITFLAG64(26),

    CSD_UNSTRETCH_HORIZONTAL = MAKE_BITFLAG64(27),

    CSD_CORNER_EXTRACT = MAKE_BITFLAG64(28),

    CSD_RADARMAP = MAKE_BITFLAG64(29),

    CSD_POD_BASE = MAKE_BITFLAG64(30),
    CSD_POD_CLONE = MAKE_BITFLAG64(31),

    CSD_MULTIPLAYER = MAKE_BITFLAG64(32),
    CSD_MULTIPLAYER_CENTER = MAKE_BITFLAG64(33),

    CSD_CHEVRON = MAKE_BITFLAG64(34),

    CSD_MODIFIER_ULTRAWIDE_ONLY = MAKE_BITFLAG64(35),
    CSD_MODIFIER_NARROW_ONLY = MAKE_BITFLAG64(36),

    CSD_SCENE_DISABLE_MOTION = MAKE_BITFLAG64(37),

    CSD_MOVIE = MAKE_BITFLAG64(38),

    CSD_CRI_LOGO = MAKE_BITFLAG64(39)
};
