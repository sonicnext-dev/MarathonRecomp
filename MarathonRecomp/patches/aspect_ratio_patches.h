...
enum CsdFlags : uint64_t
{
    ...
    CSD_MULTIPLAYER_CENTER = MAKE_BITFLAG64(31),

    CSD_CHEVRON = MAKE_BITFLAG64(32),

    CSD_MODIFIER_ULTRAWIDE_ONLY = MAKE_BITFLAG64(33),
    CSD_MODIFIER_NARROW_ONLY = MAKE_BITFLAG64(34),
    ...
    CSD_MAIN_MENU_PARTS_CAST_0221 = MAKE_BITFLAG64(38),
    CSD_MAIN_MENU_PARTS_CAST_0222 = MAKE_BITFLAG64(39),
    CSD_MAIN_MENU_PARTS_CAST_0226 = MAKE_BITFLAG64(40),
    CSD_MAIN_MENU_PARTS_CAST_0227 = MAKE_BITFLAG64(41)
};
