...
namespace Sonicteam
{
    ...
    public:
        ...
        boost::shared_ptr<TextEntity> m_TrickPointText;
        boost::shared_ptr<TextEntity> m_Field194;
        MARATHON_INSERT_PADDING(0x10);
        boost::shared_ptr<TextEntity> m_SavePointTimeText;
    };

    MARATHON_ASSERT_OFFSETOF(HUDMainDisplay, m_Field184, 0x184);
    MARATHON_ASSERT_OFFSETOF(HUDMainDisplay, m_TrickPointText, 0x18C);
