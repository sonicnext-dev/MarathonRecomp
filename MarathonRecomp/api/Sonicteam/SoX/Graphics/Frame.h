...
namespace Sonicteam::SoX::Graphics
{
    ...
    public:
        ...
        void SwapWith(Frame* pOtherFrame);
        ...
        void InsertChildBefore(Frame* pNewChild, Frame* pReferenceChild);
        void InsertChildAfter(Frame* pNewChild, Frame* pReferenceChild);
        Frame* GetLastChild() const;
        size_t GetChildCount() const;
        bool IsCircularListValid() const;
        void SafeRemove();

        // Case-insensitive and partial search
        Frame* FindNodeCaseInsensitive(const char* name);
        Frame* FindNodePartial(const char* partialName);
    };
