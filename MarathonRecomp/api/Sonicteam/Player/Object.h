...
{
    #pragma pack(push, 1)
    class alignas(1) Object : public Actor
    {
    ...
    public:
        ...
        xpointer<uint32_t> m_SpawnSource;
        bool m_IsPlayer;
        bool m_IsPosture;
        bool m_IsAmigo;
        MARATHON_INSERT_PADDING(1);
        SoX::RefSharedPointer<RootFrame> m_spRootFrame;
        SoX::RefSharedPointer<SoX::RefCountObject> m_PackageBinary
        boost::shared_ptr<IPlugIn> m_spPlayerModel;
        boost::shared_ptr<IPlugIn> m_spPlayerPosture;
        boost::shared_ptr<State::Machine2> m_spStateMachine;
        boost::shared_ptr<IPlugIn> m_spPlayerGravity;
        boost::shared_ptr<IPlugIn> m_spPlayerImpulse;
