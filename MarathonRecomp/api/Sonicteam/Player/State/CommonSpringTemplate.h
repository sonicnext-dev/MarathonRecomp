namespace Sonicteam::Player::State
{
    ...
    // Default 06 Types
    typedef CommonSpringTemplate<25, 0x40> CommonSpringTemplate_2540;
    typedef CommonSpringTemplate<75, 0x10> CommonSpringTemplate_7510;
    ...
    typedef CommonSpringTemplate<76, 0x80> CommonSpringTemplate_7680;
