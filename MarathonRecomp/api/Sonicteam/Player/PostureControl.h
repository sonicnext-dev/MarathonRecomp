...
// FOR DEBUGGING HFR ISSUES FOR POSTURE
#define MARATHON_POSTURECONTROL_USE_RECREATED_VERSION 1
...
namespace Sonicteam::Player
{
    ...
    public:
        ...
        bool m_DisableAccuratePosture; // better name?
        ...
        // Recreate from sub_82200538, Full 1:1 recreated for debugging purposes
