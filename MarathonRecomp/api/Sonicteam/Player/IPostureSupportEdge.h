...
namespace Sonicteam::Player
{
    ...
    public:
        ...
        SoX::Math::Vector m_EdgeBottomPosition;             // example -72.00,30.27 -0.53
        SoX::Math::Vector m_EdgeTopPosistion;               // -72.00 50.27 -0.53
        SoX::Math::Vector m_EdgeOffset;                     //From vector operations & lua
        SoX::Math::Vector m_EdgeHeight;                     //From Lua, c_edge_height(Y)
