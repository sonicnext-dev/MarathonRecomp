...
namespace Sonicteam::Player
{
    ...
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpDestroy, 0x00);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpFunc4, 4);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpSetControllerMovement, 8);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpIsInContact, 0xC);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpIsOffContact, 0x10);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpGetContactFlag, 0x14);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpOutContactPosition, 0x18);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpOutContactUP, 0x1C);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpFunc20, 0x20);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpFunc24, 0x24);
    MARATHON_ASSERT_OFFSETOF(IPosturePlugIn::Vftable, fpFunc28, 0x28);
