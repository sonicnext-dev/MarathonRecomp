...
namespace Sonicteam
{
    ...
    public:
        ...
        stdx::map<stdx::string, SoX::RefSharedPointer<SoX::Graphics::Surface>> m_mspDepthStencil_1_4; //SurfaceXenon
        stdx::map<stdx::string, SoX::RefSharedPointer<SoX::Graphics::Surface>> m_mspDepthStencil_256; //SurfaceXenon
